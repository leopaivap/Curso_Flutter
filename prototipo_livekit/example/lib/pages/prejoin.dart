...
class _PreJoinPageState extends State<PreJoinPage> {
  ...
  void initState() {
    ...
    if (widget.args.connection != ConnectionType.watch) {
      _subscription =
  ...
  _join(BuildContext context) async {
    ...
    try {
      ...
      await Navigator.push<void>(
        ...
        MaterialPageRoute(
            builder: (_) =>
                RoomPage(room, listener, connection: args.connection)),
      );
    } catch (error) {
  ...
  Widget build(BuildContext context) {
    return widget.args.connection != ConnectionType.watch
        ? Scaffold(
            appBar: AppBar(
              title: const Text(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton2<MediaDevice>(
                              isExpanded: true,
                              disabledHint: const Text('Câmera Desativada'),
                              hint: const Text(
                                'Selecione a Câmera',
                              ),
                              items: _enableVideo
                        ...
                        Padding(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton2<MediaDevice>(
                              isExpanded: true,
                              disabledHint: const Text('Microfone Desativado '),
                              hint: const Text(
                                'Selecione Microfone',
                              ),
                              items: _enableAudio
